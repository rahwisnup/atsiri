			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url('controller_admin/edit_data_kabupaten/')."/".$deskripsi[0]['id_kabupaten'] ?>" accept-charset="utf-8" enctype="multipart/form-data">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="nama_kabupaten" value="<?php echo $deskripsi[0]['nama_kabupaten']?>">
							  </div>
							</div>
