			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url('controller_admin/edit_data_panen/')."/".$deskripsi[0]['id_panen'] ?>" accept-charset="utf-8" enctype="multipart/form-data">
						  <fieldset>
						  ...
						  <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="luas_panen" value="<?php echo $deskripsi[0]['luas_panen']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Jumlah Panen</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="jumlah_panen" value="<?php echo $deskripsi[0]['jumlah_panen']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Tanggal panen</label>
							  <div class="controls">
								<input type="text" class="date" id="" value="<?php echo $deskripsi[0]['tanggal_panen']?>" name="tanggal_panen">
							  </div>
							</div>
