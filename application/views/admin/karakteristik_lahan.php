			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url('controller_admin/get_list_karakteristik_lahan/') ?>" accept-charset="utf-8" enctype="multipart/form-data">
						  <fieldset>
						  ...
						  <div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="date" id="" name="unsur_hara">
							  </div>
							</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php for ($i=0; $i < $perulangan ; $i++) { ?>
							...
							<td class="center span2"><?php echo $i+1 ?></td>
								<td class="span3"><?php echo $data_karakteristik_lahan[$i]['jenis_tanah']; ?></td>
								<td class="span4"><?php echo $data_karakteristik_lahan[$i]['curah_hujan']; ?></td>
								<td class="center span2"><?php echo $data_karakteristik_lahan[$i]['unsur_hara']; ?></td>
								<td class="center span2">
									<a title="Edit" class="btn btn-info" href="<?php echo base_url('controller_admin/edit_data_karakteristik_lahan')."/".$data_karakteristik_lahan[$i]['id_karakteristik']; ?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									                                            
									<a title="Hapus" class="btn btn-danger" href="<?php echo base_url('controller_admin/delete_data_karakteristik_lahan')."/".$data_karakteristik_lahan[$i]['id_karakteristik']; ?>">
