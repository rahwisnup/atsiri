			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url('controller_admin/edit_data_info_lahan/')."/".$deskripsi[0]['id_info_lahan'] ?>" accept-charset="utf-8" enctype="multipart/form-data">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="unsur_hara" value="<?php echo $deskripsi[0]['unsur_hara']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Bahan Organik</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="bahan_organik" value="<?php echo $deskripsi[0]['bahan_organik']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Ketinggian Tempat (mdpl)</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="ketinggian_tempat" value="<?php echo $deskripsi[0]['ketinggian_tempat']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Asal Benih</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="asal_benih" value="<?php echo $deskripsi[0]['asal_benih']?>">
							  </div>
							</div>
