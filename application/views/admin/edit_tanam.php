			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url('controller_admin/edit_data_tanam/')."/".$deskripsi[0]['id_tanam'] ?>" accept-charset="utf-8" enctype="multipart/form-data">
						  <fieldset>
						  ...
						  <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="luas_tanam" value="<?php echo $deskripsi[0]['luas_tanam']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Tanggal tanam</label>
							  <div class="controls">
								<input type="text" class="date" id="" value="<?php echo $deskripsi[0]['tanggal_tanam']?>" name="tanggal_tanam">
							  </div>
							</div>
